...
```curl
curl -X POST https://api.stripe.com/v1/disputes/du_1MtJUT2eZvKYlo2CNaw2HvEv/close \
  -u "<<YOUR_SECRET_KEY>>"
```

```cli
stripe disputes close du_1MtJUT2eZvKYlo2CNaw2HvEv
```
...
Dispute dispute =
  client.v1().disputes().close("du_1MtJUT2eZvKYlo2CNaw2HvEv", params);
```
