...
After you create the SetupIntent, attach a payment method and [confirm](https://docs.stripe.com/docs/api/setup_intents/confirm.md) it to collect any required permissions to charge the payment method later.
