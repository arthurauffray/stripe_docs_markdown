...
Returns a charge if a valid identifier was provided, and raises [an error](https://docs.stripe.com/api/charges/retrieve.md#errors) otherwise.
...
charge = client.v1.charges.retrieve('ch_3MmlLrLkdIwHu7ix0snN0B15')
```
...
Charge charge =
  client.v1().charges().retrieve("ch_3MmlLrLkdIwHu7ix0snN0B15", params);
```
