...
- `additional_terms_of_service` (object, optional)
  ...
  - `additional_terms_of_service.account` (object, optional)
    ...
    - `additional_terms_of_service.account.date` (timestamp, optional)
      The time when the Account’s representative accepted the terms of service. Represented as a RFC 3339 date & time UTC value in millisecond precision, for example: 2022-09-18T13:22:18.123Z.

    - `additional_terms_of_service.account.ip` (string, optional)
...
```cli
stripe v2 core accounts persons update acct_1Nv0FGQ9RKHgCVdK person_test_61RS0CgWt1xBt8M1Q16RS0Cg0WSQO5ZXUVpZxZ9tAIbY \
