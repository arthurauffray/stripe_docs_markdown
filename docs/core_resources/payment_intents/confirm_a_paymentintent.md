...
```cli
stripe payment_intents confirm pi_3MtweELkdIwHu7ix0Dt0gF2H \
...
PaymentIntent paymentIntent =
  client.v1().paymentIntents().confirm("pi_3MtweELkdIwHu7ix0Dt0gF2H", params);
```
...
result, err := sc.V1PaymentIntents.Confirm(
  context.TODO(), "pi_3MtweELkdIwHu7ix0Dt0gF2H", params)
```
