...
```cli
stripe payment_intents update pi_3MtwBwLkdIwHu7ix28a3tqPa \
  -d "metadata[order_id]"=6735
```
...
PaymentIntent paymentIntent =
  client.v1().paymentIntents().update("pi_3MtwBwLkdIwHu7ix28a3tqPa", params);
```
