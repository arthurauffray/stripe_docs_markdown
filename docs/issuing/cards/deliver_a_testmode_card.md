...
```cli
stripe test_helpers issuing cards deliver_card ic_1MvSieLkdIwHu7ixn6uuO0Xu
```

```ruby
client = Stripe::StripeClient.new("<<YOUR_SECRET_KEY>>")

card = client.v1.test_helpers.issuing.cards.deliver_card('ic_1MvSieLkdIwHu7ixn6uuO0Xu')
```

```python
client = StripeClient("<<YOUR_SECRET_KEY>>")

card = client.v1.test_helpers.issuing.cards.deliver_card(
...
$card = $stripe->testHelpers->issuing->cards->deliverCard(
  'ic_1MvSieLkdIwHu7ixn6uuO0Xu',
  []
);
```
...
CardDeliverCardParams params = CardDeliverCardParams.builder().build();

Card card =
  client.v1().testHelpers().issuing().cards().deliverCard(
    "ic_1MvSieLkdIwHu7ixn6uuO0Xu",
    params
  );
```
...
Stripe.Issuing.Card card = service.DeliverCard("ic_1MvSieLkdIwHu7ixn6uuO0Xu");
```
