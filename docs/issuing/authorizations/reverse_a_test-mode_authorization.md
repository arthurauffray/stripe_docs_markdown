...
- `reverse_amount` (integer, optional)
  The amount to reverse from the authorization. If not provided, the full amount of the authorization will be reversed. This amount is in the authorization currency and in the [smallest currency unit](https://docs.stripe.com/docs/currencies.md#zero-decimal).
...
authorization = client.v1.test_helpers.issuing.authorizations.reverse('iauth_1DPc772eZvKYlo2C6avLyZ25')
```
...
$authorization = $stripe->testHelpers->issuing->authorizations->reverse(
  'iauth_1DPc772eZvKYlo2C6avLyZ25',
  []
);
```
...
AuthorizationReverseParams params = AuthorizationReverseParams.builder().build();

Authorization authorization =
  client.v1().testHelpers().issuing().authorizations().reverse(
    "iauth_1DPc772eZvKYlo2C6avLyZ25",
    params
  );
```
