...
authorization = client.v1.issuing.authorizations.retrieve('iauth_1JVXl82eZvKYlo2CPIiWlzrn')
```

```python
client = StripeClient("<<YOUR_SECRET_KEY>>")

authorization = client.v1.issuing.authorizations.retrieve(
...
$authorization = $stripe->issuing->authorizations->retrieve(
  'iauth_1JVXl82eZvKYlo2CPIiWlzrn',
  []
);
```
...
AuthorizationRetrieveParams params = AuthorizationRetrieveParams.builder().build();

Authorization authorization =
  client.v1().issuing().authorizations().retrieve(
    "iauth_1JVXl82eZvKYlo2CPIiWlzrn",
    params
  );
```
