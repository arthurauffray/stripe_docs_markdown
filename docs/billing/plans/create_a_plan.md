...
You can now model subscriptions more flexibly using the [Prices API](https://docs.stripe.com/api/plans/create.md#prices). It replaces the Plans API and is backwards compatible to simplify your migration.
...
- `product` (object, required)
  ...
  - `product.tax_code` (string, recommended if calculating taxes)
...
- `amount` (integer, Required unless billing_scheme=tiered)
