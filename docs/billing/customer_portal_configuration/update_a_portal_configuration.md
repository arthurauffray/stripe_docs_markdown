...
```cli
stripe billing_portal configurations update bpc_1MrnZsLkdIwHu7ixNiQL1xPM \
  -d "business_profile[privacy_policy_url]"="https://example.com/new_privacy_url" \
  -d "business_profile[terms_of_service_url]"="https://example.com/new_terms_of_service_url"
```
...
Configuration configuration =
  client.v1().billingPortal().configurations().update(
    "bpc_1MrnZsLkdIwHu7ixNiQL1xPM",
    params
  );
```
