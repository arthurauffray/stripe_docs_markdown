...
With [Connect](https://docs.stripe.com/docs/connect.md), you can create Stripe accounts for your users. To do this, you’ll first need to [register your platform](https://dashboard.stripe.com/account/applications/settings).

If you’ve already collected information for your connected accounts, you [can prefill that information](https://docs.stripe.com/docs/connect/best-practices.md#onboarding) when creating the account. Connect Onboarding won’t ask for the prefilled information during account onboarding. You can prefill any information on the account.

## Returns

Returns an [`Account`](https://docs.stripe.com/api/accounts/create.md#account_object) object if the call succeeds.

## Parameters

- `account_token` (string, optional)
  An [account token](https://docs.stripe.com/api/accounts/create.md#create_account_token), used to securely provide details to the account.
...
- `capabilities` (object, Required conditionally)
...
- `company` (object, optional)
  ...
  - `company.registration_date` (object, optional)
    When the business was incorporated or registered.

    - `company.registration_date.day` (integer, required)
      The day of registration, between 1 and 31.

    - `company.registration_date.month` (integer, required)
      The month of registration, between 1 and 12.

    - `company.registration_date.year` (integer, required)
  ...
  - `company.verification` (object, optional)
    ...
    - `company.verification.document` (object, optional)
      ...
      - `company.verification.document.back` (string, optional)
        The back of a document returned by a [file upload](https://docs.stripe.com/api/accounts/create.md#create_file) with a `purpose` value of `additional_verification`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.

        The maximum length is 500 characters.

      - `company.verification.document.front` (string, optional)
        The front of a document returned by a [file upload](https://docs.stripe.com/api/accounts/create.md#create_file) with a `purpose` value of `additional_verification`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
...
- `controller` (object, optional)
  ...
  - `controller.fees` (object, optional)
    A hash of configuration for who pays Stripe fees for product usage on this account.

    - `controller.fees.payer` (enum, optional)
      A value indicating the responsible payer of Stripe fees on this account. Defaults to `account`. Learn more about [fee behavior on connected accounts](https://docs.stripe.com/connect/direct-charges-fee-payer-behavior.md).
Possible enum values:
      - `account`
  ...
  - `controller.losses` (object, optional)
    A hash of configuration for products that have negative balance liability, and whether Stripe or a Connect application is responsible for them.

    - `controller.losses.payments` (enum, optional)
...
Possible enum values:
  ...
  - `controller.requirement_collection` (enum, optional)
...
Possible enum values:
  ...
  - `controller.stripe_dashboard` (object, optional)
    A hash of configuration for Stripe-hosted dashboards.

    - `controller.stripe_dashboard.type` (enum, optional)
...
- `documents` (object, optional)
  ...
  - `documents.bank_account_ownership_verification` (object, optional)
    ...
    - `documents.bank_account_ownership_verification.files` (array of strings, optional)
      One or more document ids returned by a [file upload](https://docs.stripe.com/api/accounts/create.md#create_file) with a `purpose` value of `account_requirement`.
  ...
  - `individual.verification` (object, optional)
    ...
    - `individual.verification.additional_document` (object, optional)
      ...
      - `individual.verification.additional_document.back` (string, optional)
        The back of an ID returned by a [file upload](https://docs.stripe.com/api/accounts/create.md#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.

        The maximum length is 500 characters.

      - `individual.verification.additional_document.front` (string, optional)
        The front of an ID returned by a [file upload](https://docs.stripe.com/api/accounts/create.md#create_file) with a `purpose` value of `identity_document`. The uploaded file needs to be a color image (smaller than 8,000px by 8,000px), in JPG, PNG, or PDF format, and less than 10 MB in size.
